...
},{}],"iris-testing.json":[function(require,module,exports) {
module.exports = [{
  "sepal_length": 5.4,
  "sepal_width": 3.9,
  "petal_length": 1.7,
...
},{}],"iris.js":[function(require,module,exports) {
"use strict";
...
var _irisTesting = _interopRequireDefault(require("./iris-testing.json"));
...
const testingData = tf.tensor2d(_irisTesting.default.map(item => [item.sepal_length, item.sepal_width, item.petal_length, item.petal_width]));
